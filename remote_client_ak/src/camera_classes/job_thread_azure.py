...
Date: August 2021
Description:
    This is an wrapper to use Azure Kinect functions as a thread process.
    This class is used when we need to launch process  from loops as a remote client.
...
class JobThreadAzure(threading.Thread):
    ...
    def initialize_sensor(self):
        ...
        try:
            ...
            print("Camera not OPEN --> verify the camera!!")
            os._exit(1)
